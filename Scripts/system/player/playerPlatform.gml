...
if(yflag == 1)
{
    ...
    pf = collision_line(bbox_left + 2, bbox_top, bbox_left + 2, bbox_bottom + vspeed + gravity + abs(tempvpf) + 1, platform, 1, 1);
    if(pf == noone)
        pf = collision_line(bbox_right - 1, bbox_top, bbox_right - 1, bbox_bottom + vspeed + gravity + abs(tempvpf) + 1, platform, 1, 1);
